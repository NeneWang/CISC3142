...
void problem2(void)
{
    ...
    printf("\n%d minutes long - %s", movieVect.at(0).length, movieVect.at(0).title.c_str());
    printf("\n%d minutes long - %s", movieVect.at(1).length, movieVect.at(1).title.c_str());
    printf("\n%d minutes long - %s", movieVect.at(2).length, movieVect.at(2).title.c_str());
}
...
void problem4(void)
{
    ...
    for (MovieInformation movie : movieVect)
    {
        ...
        {
            comedyMovies.push_back(movie.year);
            // movie.printContent();
        }
    }
    ...
    cout << "\n Action Movies: \n" << endl;
    printFirsts(actionMovies, 3);

    cout << "\n Comedy Movies: \n" << endl;
    printFirsts(comedyMovies, 3);
    ...
    {
        cout << " They dont have all the years in common";
    }
}
